...
def compile(code, path='', loader=None, options=None):
    """
    ...
    """
    tree, context = compile_to_parse_tree(code, path, loader, options)
...
def compile_to_parse_tree(code, path='', loader=None, options=None):
    ...
    context = Context(path, new_loader, options)
